...
header_files = [
    ...
    ("js/public/CallArgs.h", "js/CallArgs.h"),
    ("js/public/CallNonGenericMethod.h", "js/CallNonGenericMethod.h"),
    ("js/public/CharacterEncoding.h", "js/CharacterEncoding.h"),
    ("js/public/Class.h", "js/Class.h"),
    ("js/public/GCAnnotations.h", "js/GCAnnotations.h"),
    ("js/public/GCAPI.h", "js/GCAPI.h"),
    ("js/public/GCPolicyAPI.h", "js/GCPolicyAPI.h"),
    ("js/public/GCVector.h", "js/GCVector.h"),
    ("js/public/HashTable.h", "js/HashTable.h"),
    ("js/public/HeapAPI.h", "js/HeapAPI.h"),
    ("js/public/Id.h", "js/Id.h"),
    ("js/public/Principals.h", "js/Principals.h"),
    ("js/public/ProfilingStack.h", "js/ProfilingStack.h"),
    ("js/public/Realm.h", "js/Realm.h"),
    ("js/public/RefCounted.h", "js/RefCounted.h"),
    ("js/public/Result.h", "js/Result.h"),
    ("js/public/RootingAPI.h", "js/RootingAPI.h"),
    ("js/public/Stream.h", "js/Stream.h"),
    ("js/public/StructuredClone.h", "js/StructuredClone.h"),
    ("js/public/TraceKind.h", "js/TraceKind.h"),
    ("js/public/TracingAPI.h", "js/TracingAPI.h"),
    ("js/public/TypeDecls.h", "js/TypeDecls.h"),
    ("js/public/UniquePtr.h", "js/UniquePtr.h"),
    ("js/public/Utility.h","js/Utility.h"),
    ("js/public/Value.h","js/Value.h"),
    ("js/public/Vector.h", "js/Vector.h"),
    ("js/src/js.msg", "js.msg"),
    ("js/src/jsalloc.h", "jsalloc.h"),
    ("js/src/jsapi.h", "jsapi.h"),
    ("js/src/jsbytecode.h", "jsbytecode.h"),
    ("js/src/jscpucfg.h","jscpucfg.h"),
    ("js/src/jsfriendapi.h", "jsfriendapi.h"),
    ("js/src/jsprototypes.h", "jsprototypes.h"),
    ("js/src/jspubtd.h", "jspubtd.h"),
    ("js/src/jstypes.h", "jstypes.h"),
    ("js/src/jsversion.h", "jsversion.h"),
    ...
    ("xpcom/build/ServiceList.h", "ServiceList.h"),
    ...
    ("xpcom/ds/nsTObserverArray.h", "nsTObserverArray.h"),
    ...
    ("xpcom/reflect/xptcall/xptcall.h", "xptcall.h"),
