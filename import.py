...
header_files = [
    ...
    ("xpcom/base/nsAutoPtr.h", "nsAutoPtr.h"),
    ("xpcom/base/nsCOMPtr.h", "nsCOMPtr.h"),
    ...
    ("xpcom/string/string-template-def-char.h", "string-template-def-char.h"),
    ("xpcom/string/string-template-def-unichar.h", "string-template-def-unichar.h"),
    ("xpcom/string/string-template-undef.h", "string-template-undef.h"),
