...
header_files = [
    ...
    ("dom/media/MediaSegment.h", "MediaSegment.h"),
    ...
    ("dom/media/webaudio/AlignmentUtils.h", "webaudio/AlignmentUtils.h"),
    ("dom/media/webaudio/AudioBlock.h", "webaudio/AudioBlock.h"),
    ("dom/media/webaudio/WebAudioUtils.h", "webaudio/WebAudioUtils.h"),
    ...
    ("xpcom/threads/nsProxyRelease.h", "nsProxyRelease.h"),
