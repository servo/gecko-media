...
SourceBuffer::GetBuffered(ErrorResult& aRv)
{
  ...
  if (rangeChanged) {
    mBuffered = new TimeRanges(this, intersection);
  }
...
SourceBuffer::SourceBuffer(MediaSource* aMediaSource,
  ...
  // TODO (gecko-media), mAbstractMainThread(aMediaSource->AbstractMainThread())
...
SourceBuffer::DispatchSimpleEvent(const char* aName)
{
  ...
  // TODO (ferjm) DispatchTrustedEvent(NS_ConvertUTF8toUTF16(aName));
}
