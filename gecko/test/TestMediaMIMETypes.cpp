...
void Test_MediaMIMETypes() {
  Test_MediaMIMETypesDependentMIMEType();
  Test_MediaMIMETypesMakeMediaMIMEType_bad();
  Test_MediaMIMETypesMediaMIMEType();
  Test_MediaMIMETypesMediaCodecs();
  Test_MediaMIMETypesMakeMediaExtendedMIMEType_bad();
  Test_MediaMIMETypesMediaExtendedMIMEType();
}
